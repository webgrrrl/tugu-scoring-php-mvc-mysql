        ...
        <?php require ('application/views/_templates/logindisplay.php'); ?>
          ...
          <div class="row">
            <form method="post" action="<?php echo URL; ?>admin/index2">
          ...
          */
          $flagPage = 2;
          require ('application/views/admin/navtab.php');
          ?>
          <table class="table table-condensed table-hover table-striped">
            <thead>
              <tr class="text-center">
                ...
                <th class="text-center" colspan="5">KREATIF</th>
                <th class="text-center" colspan="5">TRADISI</th>
                <th class="text-center" rowspan="2">Jumlah</th>
                <th rowspan="2"> </th>
              </tr>
              <tr>
                <?php
                $percentages = $percentages_model->getPercentages("3");
                ...
                $percentages = $percentages_model->getPercentages("4");
                foreach($percentages as $percentage) {
                  $elements = $elements_model->getElement($percentage -> ElementID);
                  $elementCode = $elements -> ElementCode;
                  echo "<th class='text-center'>" . $elementCode . "</th>\n";
